...
The FreeBSD project discourages completely new licenses and variations on the standard licenses. New licenses require the approval of [core@FreeBSD.org](mailto:core@FreeBSD.org) to reside in the main repository. In the past, non-standard licenses have generated more problems than standard ones. Poor drafting of non-standard licenses often causes more unintended consequences, so they are unlikely to be approved by [core@FreeBSD.org](mailto:core@FreeBSD.org). The FreeBSD project is standardizing on the BSD-2-Clause license, as published by SPDX.
...
Developers are reminded that, in open source, getting "open" correct is just as important as getting "source" correct. Improper handling of intellectual property has serious consequences. Any questions or concerns should immediately be brought to the attention of [core@FreeBSD.org](mailto:core@FreeBSD.org).
