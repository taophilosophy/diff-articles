...
This section provides some advice on writing status report entries from [David Chisnall](mailto:theraven@FreeBSD.org), experienced in technical writing. Instructions on how to submit your entries are also given.

*Do not worry if you are not a native English speaker. The* *[status team](mailto:status@FreeBSD.org)* *will check your entries for spelling and grammar, and fix it for you.*
