...
These guidelines describe recommended handling practices for FreeBSD Problem Reports (PRs). Whilst developed for the FreeBSD PR Database Maintenance Team [freebsd-bugbusters@FreeBSD.org](mailto:freebsd-bugbusters@FreeBSD.org), these guidelines should be followed by anyone working with FreeBSD PRs.
...
Table 1. Default Assignees - most common|Type|Categories|Default Assignee|
| ----------------------------------------| ------------| ------------------|
...
|problem with the [scsi(4)](https://man.freebsd.org/cgi/man.cgi?query=scsi&sektion=4&format=html) subsystem|kern|freebsd-scsi|mailing list|
