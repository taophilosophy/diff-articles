...
The Mirror System Coordinators can be reached through email at [mirror-admin@FreeBSD.org](mailto:mirror-admin@FreeBSD.org). There is also a [FreeBSD mirror sites mailing lists](https://lists.freebsd.org/subscription/freebsd-hubs).
...
The current disk usage of FTP Distribution can be found at [ftp://ftp.FreeBSD.org/pub/FreeBSD/dir.sizes](ftp://ftp.freebsd.org/pub/FreeBSD/dir.sizes).
