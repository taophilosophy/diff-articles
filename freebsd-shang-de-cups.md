...
Other optional, but recommended, packages are [print/gutenprint](https://cgit.freebsd.org/ports/tree/print/gutenprint/) and [print/hplip](https://cgit.freebsd.org/ports/tree/print/hplip/), both of which add drivers and utilities for a variety of printers. Once installed, the CUPS configuration files can be found in the directory /usr/local/etc/cups.
