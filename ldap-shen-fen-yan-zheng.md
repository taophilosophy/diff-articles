...
This document is intended to give the reader enough of an understanding of LDAP to configure an LDAP server. This document will attempt to provide an explanation of [net/nss_ldap](https://cgit.freebsd.org/ports/tree/net/nss_ldap/) and [security/pam_ldap](https://cgit.freebsd.org/ports/tree/security/pam_ldap/) for use with client machines services for use with the LDAP server.
